...
- [文档] 新增 Phase 1.5.1 验收脚本分层说明和环境风险文档，区分 core、full-tests 与 strict-env 检查边界。
- [新功能] 新增 Phase 2 `akshare` 真实 A 股 Raw Data Provider、独立 real-data smoke 脚本和 RawStockData 容错映射链路，保持默认 Mock acceptance 不变。

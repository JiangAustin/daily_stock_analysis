...
PRIVATE_TEST_FILES = [
    ...
    "tests/test_eastmoney_collector_mapping.py",
    "tests/test_eastmoney_parsers.py",
    "tests/test_eastmoney_endpoint_candidates.py",
    "tests/test_probe_eastmoney_endpoints.py",
    "tests/test_merge_raw_stock_data.py",
    "tests/test_composite_collector.py",
